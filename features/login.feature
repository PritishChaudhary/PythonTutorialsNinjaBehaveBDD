...
Feature: Login Functionality
  ...
  Scenario Outline: TC_LF_001 - Successful login with valid credentials
  ...
  Scenario Outline: TC_LF_002 - Warning displayed for invalid email and invalid password
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario Outline: TC_LF_003 - Warning displayed for invalid email with a valid password
    When I click on "My Account" dropmenu
    And I click on "Login" option
    And I enter "<email>" into the "E-Mail Address" field
    And I enter "<password>" into the "Password" field
  ...
  Scenario Outline: TC_LF_004 - Warning displayed for valid email with an invalid password
    When I click on "My Account" dropmenu
    And I click on "Login" option
    And I enter "<email>" into the "E-Mail Address" field
    And I enter "<password>" into the "Password" field
  ...
  Scenario: TC_LF_005 - Warning displayed when submitting the Login form with empty credentials
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_006 - Forgotten Password link visibility and redirection on the Login page
    When I click on "My Account" dropmenu
    And I click on "Login" option
    Then I should be on the Login page
  ...
  Scenario: TC_LF_007 - Successful login using Tab and Enter keyboard navigation
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_008 - Placeholder text visibility in the Email Address and Password fields
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_009 - Session persistence after pressing the browser back button post-login
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_010 - No re-login after pressing the browser back button post-logout
    When I click on "My Account" dropmenu
    And I click on "Login" option
    And I enter "john3456@gmail.com" into the "E-Mail Address" field
    And I enter "12345" into the "Password" field
  ...
  Scenario: TC_LF_011 - Login failure with inactive account credentials
    When I click on "My Account" dropmenu
    And I click on "Login" option
...
#    Then I should see a warning message "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour."
  ...
  Scenario: TC_LF_014 - Prevention of copying input text from the Password field
    When I click on "My Account" dropmenu
    And I click on "Login" option
    And I type "SamplePassword123" into the "Password" field
  ...
  Scenario: TC_LF_015 - Password field input type attribute set to password in the page source
    When I click on "My Account" dropmenu
    And I click on "Login" option
    And I type "SamplePassword123" into the "Password" field
  ...
  Scenario: TC_LF_016 - Login failure with old password and success with new password after a password change
    When I click on "My Account" dropmenu
...
#  Scenario: TC_LF_018 - Automatic logout after session timeout
#    When I click on "My Account" dropmenu
#    And I click on "Login" option
...
#    Then I should be automatically logged out
  ...
  Scenario: TC_LF_020 - Login page accessibility via three different navigation paths
  ...
  Scenario: TC_LF_021 - Correct breadcrumb, page heading, title and URL on the Login page
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_022 - Login page UI validation against the UI checklist
    When I click on "My Account" dropmenu
    And I click on "Login" option
  ...
  Scenario: TC_LF_023 - Login functionality across all supported environments
    When I click on "My Account" dropmenu
    And I click on "Login" option
